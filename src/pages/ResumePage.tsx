  ...
  return (
    <section className='resumepage' >
      ...
      <article className='generalinfo__content' >
        ...
        <p className='genralinfo__info' ><span className='generalinfo__title' >Nombre:</span> <span className='info__value' >Andres Felipe Leon Zapata</span></p>
        <p className='genralinfo__info' ><b className='generalinfo__title' >Edad:</b><span className='info__value' >35</span></p>
        <p className='genralinfo__info' ><b className='generalinfo__title' >correo:</b> <span className='info__value' >afleonz04@gmail.com</span></p>
        <p className='genralinfo__info' ><b className='generalinfo__title' >Telefono:</b> <span className='info__value' >+57 319 320 47 84</span></p>
        </div>
